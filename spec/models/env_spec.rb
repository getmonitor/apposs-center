...
describe Env do
  ...
  [config]
  url=www.alimama.com\nstatus=/home/status_ns.html\rpackage=t_site_taobaoke
  package_addr=http://yum.corp.taobao.com/taobao/t_site_taobaoke-1.0.19-170.noarch.rpm
  newpackage=t_site.rpm
  |
      @env.save.should be_true
      check_property @env
    end
    ...
    def check_property env_obj
      env_obj.reload.properties['url'].should == 'www.alimama.com'
      env_obj.properties['package'].should == 't_site_taobaoke'
      env_obj.properties['newpackage'].should == 't_site.rpm'
